...
execute as @e[type=minecraft:armor_stand,name="star"] at @s run particle minecraft:campfire_cosy_smoke ~ ~ ~ 1 1 0 0.1 5 force @a
execute as @e[type=minecraft:armor_stand,name="star"] at @s run particle minecraft:lava ~ ~ ~ 0 1 0 0.1 2 normal @a
execute as @e[type=minecraft:armor_stand,name="star"] at @s run particle minecraft:flame ~ ~ ~ 0 1 0 0.1 2 normal @a
